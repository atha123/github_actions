...
class TestClickingProductShowsDesc:
    """
        This is a test to ensure that when the user clicks on the product, the product description gets displayed.
    """
    ...
    def test_product_name_under_image(self,setup):
        ...
        assert name == 'Album', "Product details page does not show the name of the Product"
